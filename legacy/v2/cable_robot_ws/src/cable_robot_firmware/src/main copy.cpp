...
const int MEASUREMENT_INTERVAL_MS = 1000;   // Time between measurements in milliseconds
const int TOTAL_MEASUREMENT_TIME_MS = 10000; // Total time for all measurements per weight
...
// Load cell variables
HX711 scale;
float measurement_id = 0.9;  // Format: X.Y where X is weight measurement, Y is sub-measurement
...
void monitorSensor() {
  Serial.println("Monitoring sensor for 10 seconds...");
